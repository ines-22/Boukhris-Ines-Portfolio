$(document).ready(function () {
    ...
    // Contact form handling (example code if you use Google Sheets)
...
document.getElementById(projectId).style.display = "flex";
    ...
    window.addEventListener('click', function (event) {
        const modals = document.querySelectorAll('.projects_modal.active');
    ...
    // Update active section in the navbar based on scroll position
